...
def test_create_repo_with_unexpected_type_model():
...
def test_save_model(model_repo):
...
def test_save_dict_list(dict_repo):
...
def test_save_model_list(model_repo):
